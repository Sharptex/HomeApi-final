...
namespace HomeApi.Controllers
{
    ...
    public class RoomsController : ControllerBase
    {
        ...
        {
            var existingRooms = await _repository.GetRooms();
            var resp = new GetRoomsResponse { RoomAmount = existingRooms.Length, Rooms = _mapper.Map<Room[], RoomView[]>(existingRooms) };
